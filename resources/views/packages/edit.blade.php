<x-app-layout>
    <x-breadcrumb :breadcrumbs="[['url' => '/', 'label' => 'Home'],     ['url' => '/settings', 'label' => 'Settings'], ['url' => '/packages', 'label' => 'Packages'], ['url' => '#', 'label' => 'Edit Package']]" />

    <x-dynamic-heading title="Edit Package" />
    ...
    <form action="{{ route('packages.update', $package->id) }}" method="POST">
        ...
        <div class="bg-white shadow-lg sm:rounded-lg border border-gray-200 p-8">
            <div class="pb-10 mb-10 border-b border-gray-150 my-8">
                ...
                <p class="mt-1 text-sm text-gray-600">Please update the details of the package.</p>
                ...
                <div class="mt-8 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-1 mb-4">
                        ...
                        <div class="mt-2">
                            <x-text-input name="package_name" value="{{ old('package_name', $package->package_name) }}" required />
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-1 mb-4 ml-4">
                        ...
                        <div class="mt-2">
                            <x-text-input name="price" value="{{ old('price', $package->price) }}" required />
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-1 mb-4">
                        ...
                        <div class="mt-2">
                            <x-dynamic-combobox label="Select Currency" id="currency_id"
                                ...
                                :defaultValue="old('currency_id', $package->currency_id)" required />
                        </div>
                        @error('currency_id')
                    ...
                    <div class="sm:col-span-1 mb-4 ml-4">
                        ...
                        <div class="mt-2">
                            <x-text-input name="duration_months" value="{{ old('duration_months', $package->duration_months) }}" required />
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-1 mb-4">
                        ...
                        <div class="mt-2">
                            <x-text-input name="description" value="{{ old('description', $package->description) }}" />
                        </div>
                    </div>
                </div>
            </div>
