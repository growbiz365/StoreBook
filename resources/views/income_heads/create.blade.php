<x-app-layout>
    @section('title', 'Create Income Head - Income Management - StoreBook')
    ...
    <x-dynamic-heading title="Create New Income Head" />
    ...
    <div class="bg-white border border-gray-200 shadow-lg sm:rounded-xl p-6">
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-600">Fill in the information below to create a new income head. This will automatically create a linked chart of account entry under Other Income.</p>
        </div>
        ...
        <form method="POST" action="{{ route('income-heads.store') }}">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <x-text-input id="name" name="name" type="text" class="mt-1 block w-full"
                        :value="old('name')" placeholder="e.g., Interest Income, Commission, etc." required />
                    <x-input-error :messages="$errors->get('name')" class="mt-1" />
                    <p class="mt-1 text-sm text-gray-500">This will create a chart of account entry under Other Income (3200).</p>
                </div>
            </div>
