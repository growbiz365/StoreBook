<x-app-layout>
    ...
    <div class="bg-white border border-gray-200 shadow-lg sm:rounded-xl p-6">
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-600">Enter the voucher information below.</p>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="entry_type" name="entry_type" required
                        ...
                        <option value="debit" {{ old('entry_type') == 'debit' ? 'selected' : '' }}>Debit(بنـــام)</option>
                        <option value="credit" {{ old('entry_type') == 'credit' ? 'selected' : '' }}>Credit(جمـــع)</option>
                    </select>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="details" name="details" rows="3"
                        ...
                        placeholder="Optional voucher details...">{{ old('details') }}</textarea>
