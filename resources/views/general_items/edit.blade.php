<x-app-layout>
    ...
    <x-dynamic-heading title="Edit {{ $generalItem->isService() ? 'Service' : 'General Item' }}" />
        ...
        <div class="bg-white shadow-lg sm:rounded-lg border border-gray-200 p-4">
            ...
            @if($generalItem->isService())
                ...
                <div class="mb-4 grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                        <x-input-label for="item_name">Service Name <span class="text-red-500">*</span></x-input-label>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="sale_price" id="sale_price" step="any" min="0" value="{{ old('sale_price', $generalItem->sale_price ?? 0) }}"
