                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="text-center p-4 bg-blue-50 rounded-lg">
                            ...
                            <p class="text-2xl font-bold text-blue-900">{{ formatBusinessCurrency($generalItem->cost_price, true, 2) }}</p>
                        </div>
                        <div class="text-center p-4 bg-green-50 rounded-lg">
                            <label class="block text-sm font-medium text-green-600 mb-2">Sale Price</label>
                            <p class="text-2xl font-bold text-green-900">{{ formatBusinessCurrency($generalItem->sale_price, true, 2) }}</p>
                    </div>
                        <div class="text-center p-4 bg-purple-50 rounded-lg">
                            <label class="block text-sm font-medium text-purple-600 mb-2">Opening Total</label>
                            <p class="text-2xl font-bold text-purple-900">{{ formatBusinessCurrency($generalItem->opening_total, true, 2) }}</p>
                    </div>
                    </div>
