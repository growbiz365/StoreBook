<x-app-layout>
        ...
        <div class="relative flex items-center justify-between">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">Comprehensive overview of your sales management system</p>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
        ...
        <a href="{{ route('sale-invoices.create') }}"
            ...
            <div class="flex-1">
                <h3 class="text-sm font-semibold text-gray-900 group-hover:text-green-700 transition-colors duration-200">New Sale Invoice</h3>
        ...
        <a href="{{ route('sale-invoices.index') }}"
            ...
            <div class="flex-1">
                <h3 class="text-sm font-semibold text-gray-900 group-hover:text-blue-700 transition-colors duration-200">All Sales</h3>
        ...
        <a href="{{ route('quotations.index') }}"
            class="group bg-gradient-to-r from-white to-cyan-50/30 rounded-xl shadow-sm border border-gray-200 p-4 hover:shadow-lg hover:border-cyan-200 transition-all duration-300 flex items-center space-x-3 hover:-translate-y-0.5">
            <div class="flex-shrink-0 bg-gradient-to-br from-cyan-500 to-cyan-600 p-2.5 rounded-xl shadow-md group-hover:shadow-lg group-hover:scale-105 transition-all duration-300">
                <svg class="h-5 w-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
            </div>
            <div class="flex-1">
                <h3 class="text-sm font-semibold text-gray-900 group-hover:text-cyan-700 transition-colors duration-200">Quotations</h3>
        ...
        <a href="{{ route('sale-invoices.profit-loss-report') }}"
            class="group bg-gradient-to-r from-white to-purple-50/30 rounded-xl shadow-sm border border-gray-200 p-4 hover:shadow-lg hover:border-purple-200 transition-all duration-300 flex items-center space-x-3 hover:-translate-y-0.5">
            ...
            <div class="flex-1">
                <h3 class="text-sm font-semibold text-gray-900 group-hover:text-purple-700 transition-colors duration-200">Profit & Loss Report</h3>
        ...
        <a href="{{ route('sale-returns.create') }}"
            ...
            <div class="flex-1">
                <h3 class="text-sm font-semibold text-gray-900 group-hover:text-orange-700 transition-colors duration-200">Sale Return</h3>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div class="relative bg-gradient-to-br from-green-50 via-green-50 to-green-100 rounded-xl shadow-sm border border-green-100 p-5 overflow-hidden group hover:shadow-lg transition-all duration-300">
            <!-- Decorative elements -->
            ...
            <div class="relative flex items-start">
                ...
                <div class="ml-4 flex-1">
                    <div class="flex items-center justify-between">
                        <p class="text-sm font-semibold text-green-700 uppercase tracking-wide">Total Sales</p>
                        <div class="flex items-center space-x-1">
                            <div class="w-2 h-2 bg-green-400 rounded-full"></div>
                            <div class="w-1 h-1 bg-green-300 rounded-full"></div>
                        </div>
                    </div>
                    <p class="text-2xl font-bold text-green-900 mt-1">{{ number_format($saleStats['total_sales']) }}</p>
        ...
        <div class="relative bg-gradient-to-br from-blue-50 via-blue-50 to-blue-100 rounded-xl shadow-sm border border-blue-100 p-5 overflow-hidden group hover:shadow-lg transition-all duration-300">
            <!-- Decorative elements -->
            <div class="absolute top-0 right-0 w-24 h-24 opacity-10">
                <svg viewBox="0 0 100 100" class="w-full h-full">
                    <circle cx="50" cy="50" r="40" fill="none" stroke="currentColor" stroke-width="1"/>
            ...
            <div class="relative flex items-start">
                ...
                <div class="ml-4 flex-1">
                    <div class="flex items-center justify-between">
                        <p class="text-sm font-semibold text-blue-700 uppercase tracking-wide">Total Revenue</p>
                        <div class="flex items-center space-x-1">
        ...
        <div class="relative bg-gradient-to-br from-emerald-50 via-emerald-50 to-emerald-100 rounded-xl shadow-sm border border-emerald-100 p-5 overflow-hidden group hover:shadow-lg transition-all duration-300">
            <!-- Decorative elements -->
            <div class="absolute top-0 right-0 w-24 h-24 opacity-10">
                <svg viewBox="0 0 100 100" class="w-full h-full">
                    <circle cx="50" cy="50" r="40" fill="none" stroke="currentColor" stroke-width="1"/>
            ...
            <div class="relative flex items-start">
                ...
                <div class="ml-4 flex-1">
                    <div class="flex items-center justify-between">
                        <p class="text-sm font-semibold text-emerald-700 uppercase tracking-wide">Posted Sales</p>
                        <div class="flex items-center space-x-1">
        ...
        <div class="relative bg-gradient-to-br from-yellow-50 via-yellow-50 to-yellow-100 rounded-xl shadow-sm border border-yellow-100 p-5 overflow-hidden group hover:shadow-lg transition-all duration-300">
            <!-- Decorative elements -->
            <div class="absolute top-0 right-0 w-24 h-24 opacity-10">
                <svg viewBox="0 0 100 100" class="w-full h-full">
                    <circle cx="50" cy="50" r="40" fill="none" stroke="currentColor" stroke-width="1"/>
            ...
            <div class="relative flex items-start">
                ...
                <div class="ml-4 flex-1">
                    <div class="flex items-center justify-between">
                        <p class="text-sm font-semibold text-yellow-700 uppercase tracking-wide">Draft Sales</p>
                        <div class="flex items-center space-x-1">
            ...
            <div class="px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-green-600 via-green-700 to-emerald-700 relative overflow-hidden">
                ...
                <div class="relative flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-white">Sales Status</h3>
                            <p class="text-green-100 text-sm">Sales status distribution</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-orange-600 via-orange-700 to-red-700 relative overflow-hidden">
                ...
                <div class="relative flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-white">Sales Trends</h3>
                            <p class="text-orange-100 text-sm">Recent sales activity</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="p-6">
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-sm font-semibold text-gray-900">{{ $saleStats['today_sales'] }}</span>
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                        ...
                        <span class="text-sm font-semibold text-gray-900">{{ $saleStats['this_week_sales'] }}</span>
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            <div class="w-4 h-4 bg-emerald-500 rounded-full"></div>
                        ...
                        <span class="text-sm font-semibold text-gray-900">{{ $saleStats['this_month_sales'] }}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-purple-600 via-purple-700 to-pink-700 relative overflow-hidden">
                ...
                <div class="relative flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-white">Value Insights</h3>
                            <p class="text-purple-100 text-sm">Revenue metrics</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            ...
                            <span class="text-sm font-medium text-gray-700">Highest Sale</span>
                        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            ...
                            <span class="text-sm font-medium text-gray-700">Average Sale</span>
                        </div>
                        <span class="text-sm font-semibold text-gray-900">PKR {{ $saleStats['total_sales'] > 0 ? number_format($valueStats['total_value'] / $saleStats['total_sales'], 0) : 0 }}</span>
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                        ...
                        <span class="text-sm font-semibold text-gray-900">{{ number_format($saleStats['total_sales']) }}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="relative flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-emerald-100 text-sm">Latest sales activities</p>
                    </div>
                </div>
                <div class="flex items-center space-x-2">
                ...
                <div class="group relative p-3 bg-gradient-to-r from-gray-50 via-white to-gray-50 rounded-xl border border-gray-200 hover:border-green-300 hover:shadow-lg transition-all duration-300 cursor-pointer">
                    ...
                    <div class="relative flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <span class="text-sm font-medium text-gray-900 group-hover:text-green-700 transition-colors duration-200">Sale #{{ $sale->invoice_number }}</span>
                        ...
                        <span class="text-xs text-gray-500 bg-white px-2 py-1 rounded-full border border-gray-200">{{ $sale->created_at->diffForHumans() }}</span>
                    </div>
                </div>
                @endforeach
            </div>
