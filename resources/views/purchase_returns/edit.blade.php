<x-app-layout>
    @section('title', 'Edit Purchase Return - Purchases Management - StoreBook')
    ...
    <form method="POST" action="{{ route('purchase-returns.update', $purchaseReturn) }}" id="purchaseReturnForm">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white shadow-lg rounded-lg border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                    <div>
                        ...
                        <div class="searchable-select-container relative">
                            <input type="text" 
                                   ...
                                   autocomplete="off"
                                   value="{{ old('party_search_input', $purchaseReturn->party?->display_label ?? '') }}">
                            <input type="hidden" name="party_id" id="party_id" value="{{ old('party_id', $purchaseReturn->party_id) }}">
                    ...
                    <div>
                        ...
                        <select name="return_type" id="return_type" required 
                            ...
                            <option value="credit" {{ old('return_type', $purchaseReturn->return_type) == 'credit' ? 'selected' : '' }}>Credit (Party)</option>
                            <option value="cash" {{ old('return_type', $purchaseReturn->return_type) == 'cash' ? 'selected' : '' }}>Cash</option>
                        </select>
                        @error('return_type')
                        <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div id="bank_field" style="display: {{ $purchaseReturn->return_type === 'cash' ? 'block' : 'none' }};">
                        ...
                        <select name="bank_id" id="bank_id" 
                            ...
                            @foreach($banks as $bank)
                                <option value="{{ $bank->id }}" {{ old('bank_id', $purchaseReturn->bank_id) == $bank->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <input type="date" name="return_date" id="return_date" value="{{ old('return_date', $purchaseReturn->return_date->format('Y-m-d')) }}" 
            ...
            <div id="customer_details_field" style="display: {{ $purchaseReturn->return_type === 'cash' ? 'block' : 'none' }};" class="mb-4">
                <div class="bg-gray-50 border rounded-lg p-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                        <div>
                            ...
                            <input type="text" name="name_of_customer" id="name_of_customer" value="{{ old('name_of_customer', $purchaseReturn->name_of_customer) }}" 
                        ...
                        <div>
                            ...
                            <input type="text" name="father_name" id="father_name" value="{{ old('father_name', $purchaseReturn->father_name) }}" 
                        ...
                        <div>
                            ...
                            <input type="text" name="contact" id="contact" value="{{ old('contact', $purchaseReturn->contact) }}" 
                        ...
                        <div>
                            ...
                            <input type="text" name="cnic" id="cnic" value="{{ old('cnic', $purchaseReturn->cnic) }}" 
                        ...
                        <div style="display: none;">
                            ...
                            <input type="text" name="licence_no" id="licence_no" value="{{ old('licence_no', $purchaseReturn->licence_no) }}" 
                        ...
                        <div style="display: none;">
                            ...
                            <input type="date" name="licence_issue_date" id="licence_issue_date" value="{{ old('licence_issue_date', $purchaseReturn->licence_issue_date?->format('Y-m-d')) }}" 
                        ...
                        <div style="display: none;">
                            ...
                            <input type="date" name="licence_valid_upto" id="licence_valid_upto" value="{{ old('licence_valid_upto', $purchaseReturn->licence_valid_upto?->format('Y-m-d')) }}" 
                        ...
                        <div style="display: none;">
                            ...
                            <input type="text" name="licence_issued_by" id="licence_issued_by" value="{{ old('licence_issued_by', $purchaseReturn->licence_issued_by) }}" 
                        ...
                        <div style="display: none;">
                            ...
                            <input type="text" name="re_reg_no" id="re_reg_no" value="{{ old('re_reg_no', $purchaseReturn->re_reg_no) }}" 
                        ...
                        <div style="display: none;">
                            ...
                            <input type="text" name="dc" id="dc" value="{{ old('dc', $purchaseReturn->dc) }}" 
                        ...
                        <div style="display: none;">
                            ...
                            <input type="date" name="Date" id="Date" value="{{ old('Date', $purchaseReturn->Date?->format('Y-m-d')) }}" 
                        ...
                        <div class="md:col-span-2 lg:col-span-3">
                            ...
                            <textarea name="address" id="address" rows="1" 
                                      ...
                                      placeholder="Enter customer address">{{ old('address', $purchaseReturn->address) }}</textarea>
                            @error('address')
                            <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
            ...
            <div id="party_details_field" style="display: {{ $purchaseReturn->return_type == 'credit' && $purchaseReturn->party_id ? 'block' : 'none' }};" class="mb-4">
                <div class="bg-gray-50 border rounded-lg p-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                        <div>
                            ...
                            <input type="text" id="party_name" readonly 
                                   ...
                                   value="{{ $purchaseReturn->party ? $purchaseReturn->party->name : '' }}">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="party_cnic" readonly 
                                   class="w-full px-2 py-1.5 text-xs border border-gray-300 rounded bg-gray-100 text-gray-600"
                                   value="{{ $purchaseReturn->party ? $purchaseReturn->party->cnic : '' }}">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="party_contact" readonly 
                                   class="w-full px-2 py-1.5 text-xs border border-gray-300 rounded bg-gray-100 text-gray-600"
                                   value="{{ $purchaseReturn->party ? $purchaseReturn->party->phone_no : '' }}">
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="party_address" rows="1" readonly 
                                      class="w-full px-2 py-1.5 text-xs border border-gray-300 rounded bg-gray-100 text-gray-600">{{ $purchaseReturn->party ? $purchaseReturn->party->address : '' }}</textarea>
                        </div>
                        
                        <div style="display: none;">
                            <label for="party_license_no" class="block text-xs font-medium text-gray-600 mb-1">Licence No</label>
                            <input type="text" name="party_license_no" id="party_license_no" value="{{ old('party_license_no', $purchaseReturn->party_license_no) }}" 
                        ...
                        <div style="display: none;">
                            ...
                            <input type="date" name="party_license_issue_date" id="party_license_issue_date" value="{{ old('party_license_issue_date', $purchaseReturn->party_license_issue_date?->format('Y-m-d')) }}" 
                        ...
                        <div style="display: none;">
                            ...
                            <input type="date" name="party_license_valid_upto" id="party_license_valid_upto" value="{{ old('party_license_valid_upto', $purchaseReturn->party_license_valid_upto?->format('Y-m-d')) }}" 
                        ...
                        <div style="display: none;">
                            ...
                            <input type="text" name="party_license_issued_by" id="party_license_issued_by" value="{{ old('party_license_issued_by', $purchaseReturn->party_license_issued_by) }}" 
                        ...
                        <div style="display: none;">
                            ...
                            <input type="text" name="party_re_reg_no" id="party_re_reg_no" value="{{ old('party_re_reg_no', $purchaseReturn->party_re_reg_no) }}" 
                        ...
                        <div style="display: none;">
                            ...
                            <input type="text" name="party_dc" id="party_dc" value="{{ old('party_dc', $purchaseReturn->party_dc) }}" 
                        ...
                        <div style="display: none;">
                            ...
                            <input type="date" name="party_dc_date" id="party_dc_date" value="{{ old('party_dc_date', $purchaseReturn->party_dc_date?->format('Y-m-d')) }}" 
            ...
            <div class="flex justify-end space-x-4 pt-4 border-t border-gray-200">
                <a href="{{ route('purchase-returns.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    (function() {
        ...
        const isEditPage = window.location.href.includes('/purchase-returns/') && window.location.href.includes('/edit');
        ...
        const isFromDifferentPage = document.referrer && 
            !document.referrer.includes('/purchase-returns/') && 
            !document.referrer.includes('purchase-returns/');
    ...
    // Define global variables and functions
        let generalItemIndex = {{ $purchaseReturn->generalLines->count() }};
        let armIndex = {{ $purchaseReturn->armLines->count() }};
    ...
    // Handle pre-selected party from existing purchase return data
...
function initializeExistingData() {
    ...
    const existingGeneralItems = @json($purchaseReturn->generalLines);
        ...
        existingGeneralItems.forEach((line, index) => {
            ...
            setTimeout(() => {
                ...
                if (generalRow) {
                    ...
                    generalRow.querySelector('.general-qty').value = line.quantity;
        ...
        existingArms.forEach((line, index) => {
            ...
            setTimeout(() => {
                ...
                if (armRow) {
                    ...
                    armRow.querySelector('.arm-sale-price').value = line.return_price ? line.return_price : '';
                }
    ...
    debounceSearch() {
     ...
     displayResults(items, meta) {
        ...
        items.forEach((item, index) => {
            ...
            resultItem.dataset.armTitle = item.arm_title;
