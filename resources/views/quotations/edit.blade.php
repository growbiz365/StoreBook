<x-app-layout>
    @section('title', 'Edit Quotation - Sales Management - StoreBook')
    <x-breadcrumb :breadcrumbs="[
        ['url' => '/', 'label' => 'Home'],

        ['url' => '/sales-dashboard', 'label' => 'Sales Dashboard'],
        ['url' => '#', 'label' => 'Edit Quotation']
    ]" />

    <x-dynamic-heading 
        :title="'Edit Quotation'" 
        :subtitle="'Modify quotation details and items'"
    ...
    <form method="POST" action="{{ route('quotations.update', $quotation) }}" id="quotationForm">
        ...
        <div class="bg-white shadow-lg rounded-lg border border-gray-200 p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                            <div>
                                ...
                                <div class="searchable-select-container relative">
                                    <input type="text" 
                                           ...
                                           autocomplete="off"
                                           value="{{ old('party_search_input', $quotation->party?->display_label ?? '') }}">
                                    <input type="hidden" name="party_id" id="party_id" class="selected-item-id" value="{{ old('party_id', $quotation->party_id) }}">
                            ...
                            <div>
                                ...
                                <select name="payment_type" id="payment_type" required 
                                    ...
                                    <option value="credit" {{ old('payment_type', $quotation->payment_type) == 'credit' ? 'selected' : '' }}>Credit (Party)</option>
                            ...
                            <div id="bank_field" style="display: none;">
                                ...
                                <select name="bank_id" id="bank_id" 
                                    ...
                                    @foreach($banks as $bank)
                                        <option value="{{ $bank->id }}" {{ old('bank_id', $quotation->bank_id) == $bank->id ? 'selected' : '' }}>
                            ...
                            <div>
                                <label for="quotation_date" class="block text-sm font-medium text-gray-700 mb-2">
                                    Invoice Date <span class="text-red-500">*</span>
                                                                 ...
                                                                 <input type="date" name="quotation_date" id="quotation_date" value="{{ old('quotation_date', $quotation->quotation_date->format('Y-m-d')) }}" 
                            ...
                            <div>
                                ...
                                <input type="date" name="valid_until" id="valid_until"
                                    ...
                                    required
                                    class="w-full px-4 py-3 border border-gray-300 rounded-md text-sm focus:border-green-500 focus:ring-green-500 @error('valid_until') border-red-500 @enderror">
                                @error('valid_until')
                                <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                <label for="shipping_charges" class="block text-sm font-medium text-gray-700 mb-2">
                                    Shipping Charges
                                                                 ...
                                                                 <input type="number" name="shipping_charges" id="shipping_charges" value="{{ old('shipping_charges', $quotation->shipping_charges) }}" 
                                       step="0.01" min="0" 
                    ...
                    <div id="customer_details_field" style="display: {{ $quotation->payment_type === 'cash' ? 'block' : 'none' }};" class="mb-4">
                        <div class="bg-gray-50 border rounded-lg p-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                                <div>
                                    ...
                                    <input type="text" name="name_of_customer" id="name_of_customer" value="{{ old('name_of_customer', $quotation->name_of_customer) }}" 
                                ...
                                <div>
                                    ...
                                    <input type="text" name="father_name" id="father_name" value="{{ old('father_name', $quotation->father_name) }}" 
                                ...
                                <div>
                                    ...
                                    <input type="text" name="contact" id="contact" value="{{ old('contact', $quotation->contact) }}" 
                                ...
                                <div>
                                    ...
                                    <input type="text" name="cnic" id="cnic" value="{{ old('cnic', $quotation->cnic) }}" 
                                ...
                                <div style="display: none;">
                                    ...
                                    <input type="text" name="licence_no" id="licence_no" value="{{ old('licence_no', $quotation->licence_no) }}" 
                                ...
                                <div style="display: none;">
                                    ...
                                    <input type="date" name="licence_issue_date" id="licence_issue_date" value="{{ old('licence_issue_date', $quotation->licence_issue_date?->format('Y-m-d')) }}" 
                                ...
                                <div style="display: none;">
                                    ...
                                    <input type="date" name="licence_valid_upto" id="licence_valid_upto" value="{{ old('licence_valid_upto', $quotation->licence_valid_upto?->format('Y-m-d')) }}" 
                                ...
                                <div style="display: none;">
                                    ...
                                    <input type="text" name="licence_issued_by" id="licence_issued_by" value="{{ old('licence_issued_by', $quotation->licence_issued_by) }}" 
                                ...
                                <div style="display: none;">
                                    ...
                                    <input type="text" name="re_reg_no" id="re_reg_no" value="{{ old('re_reg_no', $quotation->re_reg_no) }}" 
                                ...
                                <div style="display: none;">
                                    ...
                                    <input type="text" name="dc" id="dc" value="{{ old('dc', $quotation->dc) }}" 
                                ...
                                <div style="display: none;">
                                    ...
                                    <input type="date" name="Date" id="Date" value="{{ old('Date', $quotation->Date?->format('Y-m-d')) }}" 
                                ...
                                <div class="md:col-span-2 lg:col-span-3">
                                    ...
                                    <textarea name="address" id="address" rows="1" 
                                              ...
                                              placeholder="Enter customer address">{{ old('address', $quotation->address) }}</textarea>
                                    @error('address')
                                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                    ...
                    <div id="party_details_field" style="display: {{ $quotation->payment_type == 'credit' && $quotation->party_id ? 'block' : 'none' }};" class="mb-4">
                        <div class="bg-gray-50 border rounded-lg p-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                                <div>
                                    ...
                                    <input type="text" id="party_name" readonly 
                                           ...
                                           value="{{ $quotation->party ? $quotation->party->name : '' }}">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="party_cnic" readonly 
                                           class="w-full px-2 py-1.5 text-xs border border-gray-300 rounded bg-gray-100 text-gray-600"
                                           value="{{ $quotation->party ? $quotation->party->cnic : '' }}">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="party_contact" readonly 
                                           class="w-full px-2 py-1.5 text-xs border border-gray-300 rounded bg-gray-100 text-gray-600"
                                           value="{{ $quotation->party ? $quotation->party->phone_no : '' }}">
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea id="party_address" rows="1" readonly 
                                              class="w-full px-2 py-1.5 text-xs border border-gray-300 rounded bg-gray-100 text-gray-600">{{ $quotation->party ? $quotation->party->address : '' }}</textarea>
                                </div>
                                
                                <div style="display: none;">
                                    <label for="party_license_no" class="block text-xs font-medium text-gray-600 mb-1">Licence No</label>
                                    <input type="text" name="party_license_no" id="party_license_no" value="{{ old('party_license_no', $quotation->party_license_no) }}" 
                                ...
                                <div style="display: none;">
                                    ...
                                    <input type="date" name="party_license_issue_date" id="party_license_issue_date" value="{{ old('party_license_issue_date', $quotation->party_license_issue_date?->format('Y-m-d')) }}" 
                                ...
                                <div style="display: none;">
                                    ...
                                    <input type="date" name="party_license_valid_upto" id="party_license_valid_upto" value="{{ old('party_license_valid_upto', $quotation->party_license_valid_upto?->format('Y-m-d')) }}" 
                                ...
                                <div style="display: none;">
                                    ...
                                    <input type="text" name="party_license_issued_by" id="party_license_issued_by" value="{{ old('party_license_issued_by', $quotation->party_license_issued_by) }}" 
                                ...
                                <div style="display: none;">
                                    ...
                                    <input type="text" name="party_re_reg_no" id="party_re_reg_no" value="{{ old('party_re_reg_no', $quotation->party_re_reg_no) }}" 
                                ...
                                <div style="display: none;">
                                    ...
                                    <input type="text" name="party_dc" id="party_dc" value="{{ old('party_dc', $quotation->party_dc) }}" 
                                ...
                                <div style="display: none;">
                                    ...
                                    <input type="date" name="party_dc_date" id="party_dc_date" value="{{ old('party_dc_date', $quotation->party_dc_date?->format('Y-m-d')) }}" 
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200" id="general_items_table">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200" id="general_items_container">
                                    @foreach($quotation->generalLines as $index => $line)
                            ...
                            <button type="button" id="add_arm" class="inline-flex items-center px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-md shadow-sm transition-colors duration-150 ease-in-out">
                             ...
                             <table class="min-w-full divide-y divide-gray-200" id="arms_table">
                                 ...
                                 <tbody class="bg-white divide-y divide-gray-200" id="arms_container">
                                    @foreach($quotation->armLines as $index => $line)
                                        <tr class="arm-row">
                                            <td class="px-4 py-4 whitespace-nowrap">
                                                <div class="searchable-select-container relative">
                                                    <input type="text" 
    ...
    (function() {
        ...
        const isEditPage = window.location.href.includes('/quotations/') && window.location.href.includes('/edit');
        ...
        const isFromDifferentPage = document.referrer && 
            !document.referrer.includes('/quotations/') && 
            !document.referrer.includes('quotations/');
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('party_id').addEventListener('change', function() {
            ...
            if (this.value) {
                ...
                const saleType = document.getElementById('payment_type').value;
                if (saleType === 'credit') {
        ...
        const invoiceDateInput = document.getElementById('quotation_date');
        ...
        // Handle pre-selected party from existing quotation data
        ...
        const saleTypeSelect = document.getElementById('payment_type');
