...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement('UPDATE purchase_returns SET return_number = id');

        Schema::table('purchase_returns', function (Blueprint $table) {
            $table->unsignedInteger('return_number')->nullable(false)->change();
            $table->unique(['business_id', 'return_number'], 'purchase_returns_business_return_number_unique');
        });
    }
    ...
    {
        Schema::table('purchase_returns', function (Blueprint $table) {
            $table->dropUnique('purchase_returns_business_return_number_unique');
